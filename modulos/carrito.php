...
if(isset($finalizar)){
	...
	while($r2=mysqli_fetch_array($q2)){
		...
		$mysqli->query("INSERT INTO producto_compra (id_compra,id_producto,cantidad,monto) VALUES ('$ultima_compra','".$r2['id_producto']."','".$r2['cant']."','$monto')");
	...
	alert("Se ha fizalizado la compra");
		redir("./");
...
<br>
<h2>Monto Total: <b class="text-green"><?=$monto_total?> <?=$divisa?></b>
