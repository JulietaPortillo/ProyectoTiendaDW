...
if(isset($_SESSION['id'])){  /*Si hay una sesion iniciada seguimos con el código */
	?>
	<a href="?p=agregar_producto">
		<button class="btn btn-primary"><i class="fa fa-plus-circle"></i> Agregar Productos</button>
	</a>
	<a href="logout.php"><button class="btn btn-primary"><i class="fa fa-plus-circle"></i>Logout</button></a>
	<?php
}else{				/* De lo contrario mostramos el login*/
	?>
	<center>
